...
calculation_step = MathDocTree("step", "A step, typically an equality or inequality, in a calculation or computation.", give_json="string")
...
### Errors
errors = MathDocTree("errors", "An error in a proof or calculation. Report only actual errors, with missing steps reported in the 'missing' field.", give_json = "string")
error = MathDocTree("error", node_sequence_txt("error"), children = [errors], optional=True)

assert_children = [claim, proof_method, deduced_from_results, calculate, missing_proofs, error]
...
theorem = MathDocTree("theorem", "A mathematical theorem, with a list of hypotheses and a conclusion.", children = [statement, hypothesis, conclusion, proved, proof, ref, cite, missing_proofs, error])
root_child.append(theorem)

## Problem

problem_statement = MathDocTree("problem_statement", "The statement of the problem.", give_json="string")
...
problem = MathDocTree("problem", "A mathematical problem, with a statement and an answer.", children = [problem_statement, solved, answer, proof, missing_proofs, error], give_json="object", post_text= subkeys_posttext)
...
case = MathDocTree("case", "A case in a proof by cases or proof by induction.", children = [condition, proof, missing_proofs, error], give_json="object", post_text= subkeys_posttext)
...
cases = MathDocTree("cases", "A proof by cases or proof by induction, with a list of cases.", children = [split_kind, on, proof_cases, exhaustiveness, missing_proofs, error], give_json="object", post_text= subkeys_posttext)
...
contradiction = MathDocTree("contradiction", "A proof by contradiction, with an assumption and a proof of the contradiction.", children = [assumption, assumption_proof, missing_proofs, error], give_json="object", post_text= subkeys_posttext)
...
conclude = MathDocTree("conclude", "conclude a claim obtained from the steps so far. this is typically the final statement of a proof giving the conclusion of the theorem.", children = [ conlusion_claim, missing_proofs, error], give_json="object", post_text= subkeys_posttext)
